...
class MyPythonNode(Node):
    ...
    def OdoCallback(self, data):
        ...
        if (self.init_a0):
            ...
            # actually shouldnt be a problem but...why double initialization?
            self.integral_error = 0
            self.init_a0 = False
        ...
        # desired_yaw = int(angle.angular.z) # trying to get rid of zierd movement 
    ...
    def pingerCallback(self, data):
        ...
        self.stop_distance = 1.3 # more than 1meter
